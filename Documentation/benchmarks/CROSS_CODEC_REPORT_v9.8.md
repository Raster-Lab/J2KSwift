# Cross-Codec Benchmark — v9.8 (commit 595fba1, merged into main as bbee839)

**Date:** 2026-05-12
**Host:** Apple M2, macOS, Swift release build
**v9.8 commit:** `595fba1` "v9.8: SIGTRAP fix in encodeViaQstepSearch + corpus calibration data" (tip of `origin/v9.5-research`)
**Measured on:** `main @ bbee839` (Merge v9.5-research → main) — verified bit-identical to `595fba1` via `git diff --stat 595fba1..bbee839 -- Sources/ Tests/ Scripts/` → zero diff.
