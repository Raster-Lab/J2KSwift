...
File format support for the JPEG 2000 family of standards: JP2, J2K, JPX, and JPM.

## Overview

J2KFileFormat handles reading and writing JPEG 2000 file formats as defined by ISO/IEC 15444-1 (JP2), ISO/IEC 15444-2 (JPX), and ISO/IEC 15444-6 (JPM). The module implements the box-based file structure used across all JPEG 2000 container formats.
