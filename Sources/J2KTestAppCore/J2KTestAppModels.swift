...
// These types live in the J2KTestAppCore library target so they can
// be used by the J2KTestApp executable, the `j2k testapp --headless`
// CLI subcommand (J2KCLICore), and the J2KTestAppTests test target.
//
